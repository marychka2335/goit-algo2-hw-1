...
4. Прикріпіть посилання на репозиторій goit-algo2-hw-01 та відправте на перевірку.
...
Залік/незалік
 ...
 💡Завдання 2 не є обов’язковим до виконання для отримання заліку, проте за умови його виконання ви отримаєте конструктивний зворотний зв’язок від ментора.
